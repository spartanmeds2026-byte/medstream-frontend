        ...
        <div class="p-5">
          <Preview.Panel>
            <div class="text-center">
              ...
              <Notification
                ref-key="basicNonStickyNotification"
                :options="{
                  duration: 3000,
                }"
              ...
              <Notification
                ref-key="basicStickyNotification"
                class="flex flex-col sm:flex-row"
              >
                <div class="font-medium">
                  Yay! Updates Published!
        ...
        <div class="p-5">
          <Preview.Panel>
            <div class="text-center">
              <!-- BEGIN: Notification Content -->
              <Notification
                ref-key="notificationWithActions"
                class="flex"
              >
        ...
        <div class="p-5">
          <Preview.Panel>
            <div class="text-center">
              <!-- BEGIN: Notification Content -->
              <Notification
                ref-key="notificationWithAvatar"
                :options="{
                  close: false,
                }"
                class="flex"
        ...
        <div class="p-5">
          <Preview.Panel>
            <div class="text-center">
              <!-- BEGIN: Notification Content -->
              <Notification
                ref-key="notificationWithSplitButtons"
                :options="{
                  close: false,
                }"
                class="flex"
        ...
        <div class="p-5">
          <Preview.Panel>
            <div class="text-center">
              <!-- BEGIN: Notification Content -->
              <Notification
                ref-key="notificationWithButtonsBelow"
                :options="{
                  close: false,
                }"
                class="flex"
