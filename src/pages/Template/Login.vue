		...
		<div class="container relative z-10 sm:px-10">
			<div class="block grid-cols-2 gap-4 xl:grid">
				...
				<div class="flex-col hidden min-h-screen xl:flex">
					<a href="" class="flex flex-col pt-5 -intro-x text-white">
						<logoUrl class="w-max max-h-16" />
						<span class="ml-3 text-lg">Midone</span>
					</a>
					<div class="my-auto">
						<illustrationUrl class="w-1/2 -mt-16 -intro-x" />
						<div
