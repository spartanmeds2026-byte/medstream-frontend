	...
	<div class="grid grid-cols-12 gap-5 mt-5 intro-y">
				...
				<Tab.Panels>
					<Tab.Panel class="p-5">
						...
						>
							...
							<div class="mt-5">
								<div>
									<FormLabel html-for="post-form-7"> Caption </FormLabel>
									<FormInput
										id="post-form-7"
										type="text"
		...
		<div class="col-span-12 lg:col-span-4">
			<div class="p-5 intro-y box">
				...
				<div class="mt-3">
					<FormLabel html-for="post-form-2"> Post Date </FormLabel>
					<Litepicker
				...
				<div class="mt-3">
					<FormLabel html-for="post-form-3"> Categories </FormLabel>
					<TomSelect
						id="post-form-3"
						v-model="categories"
						class="w-full"
				...
				<div class="mt-3">
					<FormLabel html-for="post-form-4"> Tags </FormLabel>
				...
				<FormSwitch class="flex flex-col items-start mt-3">
					<FormSwitch.Label html-for="post-form-5" class="mb-2 ml-0">
						Published
					</FormSwitch.Label>
					<FormSwitch.Input id="post-form-5" type="checkbox" />
				</FormSwitch>
				<FormSwitch class="flex flex-col items-start mt-3">
					<FormSwitch.Label html-for="post-form-6" class="mb-2 ml-0">
						Show Author Name
					</FormSwitch.Label>
