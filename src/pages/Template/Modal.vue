		...
		<div class="col-span-12 intro-y lg:col-span-6">
							...
							<Dialog.Panel>
								...
								<Dialog.Description class="grid grid-cols-12 gap-4 gap-y-3">
									<div class="col-span-12 sm:col-span-6">
										<FormLabel html-for="modal-form-1"> From </FormLabel>
										<FormInput
											id="modal-form-1"
											type="text"
									...
									<div class="col-span-12 sm:col-span-6">
										<FormLabel html-for="modal-form-2"> To </FormLabel>
										<FormInput
											id="modal-form-2"
											type="text"
											placeholder="example@gmail.com"
									...
									<div class="col-span-12 sm:col-span-6">
										<FormLabel html-for="modal-form-3"> Subject </FormLabel>
										<FormInput
											id="modal-form-3"
											type="text"
									...
									<div class="col-span-12 sm:col-span-6">
										<FormLabel html-for="modal-form-4">
											Has the Words
										</FormLabel>
										<FormInput
											id="modal-form-4"
									...
									<div class="col-span-12 sm:col-span-6">
										<FormLabel html-for="modal-form-5">
											Doesn't Have
										</FormLabel>
										<FormInput
											id="modal-form-5"
									...
									<div class="col-span-12 sm:col-span-6">
										<FormLabel html-for="modal-form-6"> Size </FormLabel>
			...
			<Preview v-slot="{ toggle }" class="mt-5 intro-y box">
				...
				>
					...
					<FormSwitch class="w-full mt-3 sm:w-auto sm:ml-auto sm:mt-0">
						<FormSwitch.Label html-for="show-example-11">
							Show example code
						</FormSwitch.Label>
						<FormSwitch.Input
							id="show-example-11"
			...
			<Preview v-slot="{ toggle }" class="mt-5 intro-y box">
				...
				>
					...
					<FormSwitch class="w-full mt-3 sm:w-auto sm:ml-auto sm:mt-0">
						<FormSwitch.Label html-for="show-example-12">
							Show example code
						</FormSwitch.Label>
						<FormSwitch.Input
							id="show-example-12"
