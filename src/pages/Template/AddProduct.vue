		...
		>
			<div class="flex items-center">
				...
				<span>
					...
					<a
						href="https://themeforest.net/item/Medstream Global Portal-jquery-tailwindcss-html-admin-template/26366820"
							...
							<div class="flex-1 w-full mt-3 xl:mt-0">
								<div class="flex flex-col sm:flex-row">
									<FormCheck class="mr-4">
										...
										/>
										<FormCheck.Label html-for="condition-new">
											New
										</FormCheck.Label>
									</FormCheck>
									<FormCheck class="mt-2 mr-4 sm:mt-0">
										...
										/>
										<FormCheck.Label html-for="condition-second">
											Second
										</FormCheck.Label>
									</FormCheck>
								</div>
							...
							<div class="flex-1 w-full mt-3 xl:mt-0">
								<div class="overflow-x-auto">
									<Table class="border">
										...
										<Table.Tbody>
											<Table.Tr>
												<Table.Td :row-span="3" class="border-r">
													Small
												</Table.Td>
							...
							<div class="flex-1 w-full mt-3 xl:mt-0">
								<FormSwitch>
									<FormSwitch.Input
										...
										type="checkbox"
									/>
									<FormSwitch.Label html-for="product-status-active">
										Active
									</FormSwitch.Label>
								</FormSwitch>
							</div>
								...
								<div class="flex flex-col sm:flex-row">
									<FormCheck class="mr-4">
										<FormCheck.Input
											...
											value="horizontal-radio-chris-evans"
										/>
										<FormCheck.Label html-for="shipping-service-standard">
											Standard
										</FormCheck.Label>
									</FormCheck>
									<FormCheck class="mt-2 mr-4 sm:mt-0">
										<FormCheck.Input
											...
											value="horizontal-radio-liam-neeson"
										/>
										<FormCheck.Label html-for="shipping-service-custom">
											Custom
										</FormCheck.Label>
									</FormCheck>
								</div>
