						...
						>
							<div class="grid grid-cols-12 gap-4 p-3 gap-y-3">
								<div class="col-span-6">
									<FormLabel html-for="input-filter-1" class="text-xs">
										From
									</FormLabel>
									<FormInput
										id="input-filter-1"
								...
								<div class="col-span-6">
									<FormLabel html-for="input-filter-2" class="text-xs">
										To
									</FormLabel>
									<FormInput
										id="input-filter-2"
								...
								<div class="col-span-6">
									<FormLabel html-for="input-filter-3" class="text-xs">
										Subject
									</FormLabel>
									<FormInput
										id="input-filter-3"
								...
								<div class="col-span-6">
									<FormLabel html-for="input-filter-4" class="text-xs">
										Has the Words
									</FormLabel>
									<FormInput
										id="input-filter-4"
								...
								<div class="col-span-6">
									<FormLabel html-for="input-filter-5" class="text-xs">
										Doesn't Have
									</FormLabel>
									<FormInput
										id="input-filter-5"
								...
								<div class="col-span-6">
									<FormLabel html-for="input-filter-6" class="text-xs">
										Size
									</FormLabel>
