...
<template>
		...
		<Dialog.Panel>
			...
			<Dialog.Description class="grid grid-cols-12 gap-4 gap-y-3">
				<div class="col-span-12">
					<FormLabel html-for="pos-form-1"> Name </FormLabel>
					<FormInput
						id="pos-form-1"
						type="text"
						class="flex-1"
				...
				<div class="col-span-12">
					<FormLabel html-for="pos-form-2"> Table </FormLabel>
					<FormInput
						id="pos-form-2"
						type="text"
						class="flex-1"
				...
				<div class="col-span-12">
					<FormLabel html-for="pos-form-3"> Number of People </FormLabel>
					<FormInput
						id="pos-form-3"
						type="text"
						class="flex-1"
	...
	>
		<Dialog.Panel>
			...
			<Dialog.Description class="grid grid-cols-12 gap-4 gap-y-3">
				<div class="col-span-12">
					<FormLabel html-for="pos-form-4" class="form-label">
						Quantity
					</FormLabel>
				...
				<div class="col-span-12">
					<FormLabel html-for="pos-form-5"> Notes </FormLabel>
			...
			<Dialog.Footer class="text-right">
				...
				<Button ref="addItemRef" variant="primary" type="button" class="w-24">
					Add Item
				</Button>
			</Dialog.Footer>
		</Dialog.Panel>
