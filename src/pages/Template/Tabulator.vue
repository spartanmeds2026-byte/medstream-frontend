			...
			columns: [
				...
				},
				{
                    ...
                    <div class="w-10 h-10 intro-x image-fit">
                      <img alt="Medstream Global Portal Tailwind HTML Admin Template" class="rounded-full shadow-[0px_0px_0px_2px_#fff,_1px_1px_5px_rgba(0,0,0,0.32)] dark:shadow-[0px_0px_0px_2px_#3f4865,_1px_1px_5px_rgba(0,0,0,0.32)]" src="${
												imageAssets[
...
<template>
	...
	<div class="p-5 mt-5 intro-y box">
		...
		<div class="overflow-x-auto scrollbar-hidden">
			<div id="tabulator" ref="tableRef" class="mt-5" />
		</div>
	</div>
	<!-- END: HTML Table Data -->
</template>
