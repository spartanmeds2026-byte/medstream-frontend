	...
	<div class="grid grid-cols-12 gap-6 mt-5">
		<div class="col-span-12 intro-y lg:col-span-6">
			...
			<div class="p-5 intro-y box">
				<div>
					<FormLabel html-for="crud-form-1"> Product Name </FormLabel>
					<FormInput
						id="crud-form-1"
						type="text"
						class="w-full"
				...
				<div class="mt-3">
					<FormLabel html-for="crud-form-2"> Category </FormLabel>
					<TomSelect
						id="crud-form-2"
						v-model="categories"
						class="w-full"
				...
				<div class="mt-3">
					<FormLabel html-for="crud-form-3"> Quantity </FormLabel>
					<InputGroup>
						<FormInput
							id="crud-form-3"
							type="text"
				...
				<div class="mt-3">
					<FormLabel html-for="crud-form-4"> Weight </FormLabel>
					<InputGroup>
						<FormInput
							id="crud-form-4"
							type="text"
