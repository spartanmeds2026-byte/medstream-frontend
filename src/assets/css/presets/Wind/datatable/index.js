export default {
	...
	loadingoverlay: {
		class: [
			...
			// Color
			"bg-surface-100/70 dark:bg-surface-800/70",
	...
	bodyrow: ({ context, props }) => ({
		class: [
			...
			"dark:text-white/80",
			{
				"bg-primary-100 dark:bg-surface-500/30 text-primary":
			...
			{
				"hover:bg-primary-100 hover:text-primary-700 dark:hover:bg-primary-400/30":
